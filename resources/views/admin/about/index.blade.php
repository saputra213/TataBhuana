                ...
                <form action="{{ route('admin.about.update') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="about_hero_title" class="form-label">Judul Hero</label>
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="about_hero_subtitle" class="form-label">Subjudul Hero</label>
                    ...
                    <div class="mb-3">
                        <label for="about_main_text" class="form-label">Paragraf Utama</label>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('about_vision_title') is-invalid @enderror" id="about_vision_title" name="about_vision_title" value="{{ old('about_vision_title', $profile->about_vision_title ?? '') }}">
                        @error('about_vision_title')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-3">
                                <label for="about_vision_text" class="form-label">Deskripsi Visi</label>
                                <textarea class="form-control @error('about_vision_text') is-invalid @enderror" id="about_vision_text" name="about_vision_text" rows="3">{{ old('about_vision_text', $profile->about_vision_text ?? '') }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('about_mission_title') is-invalid @enderror" id="about_mission_title" name="about_mission_title" value="{{ old('about_mission_title', $profile->about_mission_title ?? '') }}">
                                @error('about_mission_title')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3">
                                <label for="about_mission_text" class="form-label">Deskripsi Misi</label>
                                <textarea class="form-control @error('about_mission_text') is-invalid @enderror" id="about_mission_text" name="about_mission_text" rows="3">{{ old('about_mission_text', $profile->about_mission_text ?? '') }}</textarea>
